...
const VARIANTS = {
  ...
  outline:
    'group inline-flex items-center justify-center px-12 py-5 border border-white/20 text-white backdrop-blur-sm hover:border-white transition-all duration-500 uppercase text-[14px] tracking-[0.4em] font-sans',
  ghost:
